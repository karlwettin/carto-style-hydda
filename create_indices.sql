...
-- Without this, expect any tile to take 15 minutes to render for full/roads and labels.
CREATE INDEX planet_osm_polygon_way_area_idx ON planet_osm_polygon (way_area);
